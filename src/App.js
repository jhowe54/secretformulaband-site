    ...
    <div className="App flex flex-col">
      ...
      <main className="flex flex-col items-center bg-black text-white">
        ...
        <p id="bio-1" className=" lg:px-20 md:px-10 px-4 py-4">
          The <span className="text-lg text-blue-300">Secret Formula Band</span>{" "}
          is a southern rock group out of Charlotte, North Carolina, that has
          been together since February 2022. The group brings a rugged, soulful
          noise to the stage that sounds as good as Miller Lite tastes. Drawing
          inspiration from some of their favorite blues, rock, and country
          artists – BB King, Pink Floyd, Tyler Childers, Lynyrd Skynyrd, and
          Grateful Dead - the group brings dynamic, improvisational music with a
          distinctly southern flair.
        </p>
        ...
        <section
          id="media"
          className="flex flex-col justify-center content-center items-center w-full text-white p-4 text-center"
        >
          <Gallery />
        </section>
      </main>
      <section
        id="shows"
        className="text-white bg bg-black p-4 flex flex-col items-center justify-center content-center text-center "
      >
      ...
      <section className="text-white bg bg-[#0C0C0C] p-4 flex flex-col items-center justify-center content-center text-center ">
        <Social />
      </section>
    </div>
  );
